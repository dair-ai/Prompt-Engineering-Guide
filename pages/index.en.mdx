...
<Callout type= "info" emoji="🎓">
  Due to high demand, we've partnered with Maven to deliver a [live cohort-based course on Prompt Engineering for LLMs](https://maven.com/dair-ai/prompt-engineering-llms). We are now offering a special discount for our learners. Use promo code MAVENAI20 for a 20% discount.
</Callout>